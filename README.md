...
ordinals and applies every version 5 transition, retaining each invocation
...
The current version 5 artifact preserves version 4 sampling semantics and
retains exact schema-valid copyedit diagnostics; versions 1–4 keep their frozen
historical semantics. Its four subject outcomes are `completed`,
