...
import { verifyEvaluationBenchmarkBrowsing } from "../../../apps/eval/src/evaluation-browse-verifier";
...
async function run(ctx: WalkContext): Promise<void> {
	...
	await verifyEvaluationBenchmarkBrowsing(join(ctx.persistDir, "evaluation-browse"));
