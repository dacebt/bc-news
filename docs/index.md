...
- [Active thickening: four hosted model scorecards](thickenings/active.md) — Active WSD thickening for building and reopening four local V3 scorecards from the completed hosted benchmark matrix.
