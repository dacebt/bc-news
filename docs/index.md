...
- [Active thickening: observable model runtime evidence](thickenings/active.md) — Active WSD thickening for browsing a truthful normalized runtime fingerprint on every retained benchmark invocation.
