...
- [Active thickening](thickenings/active.md) — Complete every schema-valid paper after one copyedit pass while retaining all non-schema findings as diagnostics.
