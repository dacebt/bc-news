...
- Treat statements about what someone can or cannot do, system rules, and answers explaining how something works as capability or advice, not as achievements. A routine past action offered only to explain that capability or answer remains supporting advice; it does not become a milestone merely because it was completed;
...
- Remove any item whose only evidence is a routine example offered to explain a capability, system rule, or answer;
