...
export async function evaluateTrialCommand(options: EvaluateTrialCommandOptions): Promise<EvaluateTrialCommandResult> {
	...
	const benchmark = BenchmarkRunSchema.parse({
		version: 4, id: benchmarkId, lifecycle: "running", started_at: startedAt, completed_at: null,
	...
	if (executed.version !== 4) throw new Error("Single-trial evaluation changed artifact version");
	...
	if (completed.version !== 4) throw new Error("Single-trial evaluation completion changed artifact version");
