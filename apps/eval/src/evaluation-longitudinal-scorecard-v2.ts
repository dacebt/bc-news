...
export const EvaluationLongitudinalDeclarationV2Schema = z.strictObject({
...
export const StableLongitudinalContextV2Schema = z.discriminatedUnion("state", [IdentifiedStableContextSchema, UnknownStableContextSchema]);
export type StableLongitudinalContextV2 = z.infer<typeof StableLongitudinalContextV2Schema>;
...
const ContextSourceSchema = z.strictObject({ ...SourceIdentitySchema.shape, context: StableLongitudinalContextV2Schema });
...
const RoleHistoryBaseSchema = z.strictObject({
	...
	sources: z.array(ContextSourceSchema).min(2), stable_contexts: z.array(StableLongitudinalContextV2Schema).min(2), context_differences: z.array(ContextDifferenceSchema),
...
export const EvaluationLongitudinalRoleHistoryV2Schema = RoleHistoryBaseSchema;
export type EvaluationLongitudinalRoleHistoryV2 = z.infer<typeof EvaluationLongitudinalRoleHistoryV2Schema>;
...
export const EvaluationLongitudinalScorecardArtifactV2Schema = z.strictObject({
...
export type EvaluationLongitudinalDeclarationV2 = z.infer<typeof EvaluationLongitudinalDeclarationV2Schema>;
export type EvaluationLongitudinalScorecardArtifactV2 = z.infer<typeof EvaluationLongitudinalScorecardArtifactV2Schema>;
