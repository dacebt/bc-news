...
import type { EvaluationFinding, V5BenchmarkRun, V5EvaluationTrial, V5SubjectOutcome } from "./evaluation-artifact";
...
export function emptyOutcomeCounts(): V5BenchmarkRun["outcome_counts"] {
	return { completed: 0, parse_rejected: 0, contract_rejected: 0, infrastructure_incomplete: 0 };
}
export function emptyTrack(): V5EvaluationTrial["tracks"]["main_story"] {
...
export function terminalVersion5TrackOutcome(trial: V5EvaluationTrial, track: "main_story" | "announcements"): V5SubjectOutcome {
