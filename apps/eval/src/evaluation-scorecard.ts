...
export const OutputAnnotationSchema = z.strictObject({
	annotation_id: EvaluationIdSchema, output: OutputIdentitySchema, factual_claim_inventory_complete: z.literal(true),
...
export const QualitativeReviewBundleSchema = z.strictObject({
	...
	reviews: z.array(z.strictObject({ review_id: EvaluationIdSchema, output: OutputIdentitySchema, criteria: z.tuple([
...
export type ScorecardContext = z.infer<typeof ContextSchema>;
