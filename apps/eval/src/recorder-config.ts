...
export interface RecorderConfig {
	readonly production_steps: Readonly<Record<CurrentProductionModelStep, LiveModelAdapterConfig>>;
}
...
export class RecorderConfigError extends Error {
	...
	constructor(productionStep: CurrentProductionModelStep, adapter: "recorded" | "cloudflare_ai_gateway" = "recorded") {
